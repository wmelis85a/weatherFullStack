...
from typing import (Any, BinaryIO, ContextManager, NamedTuple, NewType, TextIO,
                    TypeVar, Union)
...
class _ReadContext[I: (TextIO, BinaryIO)](ContextManager[I]):
    """A utility class to handle a context for both a reader and a progress."""

    def __init__(self, progress: "Progress", reader: I) -> None:
        self.progress = progress
        self.reader: I = reader
