...
from app.services.weather_service import getDetailedConditions, getHomeForecast, getDailyForecast
...
async def get_daily_forecast(city: str = Query(..., description="Weather Api city name")):
