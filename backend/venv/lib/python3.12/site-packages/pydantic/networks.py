...
if TYPE_CHECKING:
    ...
    type NetworkType = "str | bytes | int | tuple[str | bytes | int, str | int]"
...
type IPvAnyAddressType = "IPv4Address | IPv6Address"
type IPvAnyInterfaceType = "IPv4Interface | IPv6Interface"
type IPvAnyNetworkType = "IPv4Network | IPv6Network"
