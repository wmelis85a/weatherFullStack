...
type Deprecated = warnings.deprecated | deprecated
...
def PrivateAttr[
    T
](default: _T, *, init: Literal[False] = False,) -> _T: ...
@overload  # `default_factory` argument set
def PrivateAttr[
    T
](*, default_factory: Callable[[], _T], init: Literal[False] = False,) -> _T: ...
...
@typing.overload
def computed_field[PropertyT](func: PropertyT, /) -> PropertyT: ...
