...
class _Pipeline[InT, OutT]:
    ...
    def transform(
        ...
        """
        return _Pipeline[InT, _NewOutT](self._steps + (_Transform(func),))
    ...
    def validate_as(
        ...
        if isinstance(tp, EllipsisType):
            return _Pipeline[InT, Any](
                self._steps + (_ValidateAs(_FieldTypeMarker, strict=strict),)
            )
        return _Pipeline[InT, _NewOutT](self._steps + (_ValidateAs(tp, strict=strict),))
    ...
    def validate_as_deferred(
        ...
        """
        return _Pipeline[InT, _NewOutT](self._steps + (_ValidateAsDefer(func),))
    ...
    def constrain(self, constraint: _ConstraintAnnotation) -> Any:
        ...
        """
        return _Pipeline[InT, OutT](self._steps + (_Constraint(constraint),))
