...
def make_arbitrary_type_validator[T](type_: type[T]) -> Callable[[T], T]:
...
def make_class_validator[T](type_: type[T]) -> Callable[[Any], type[T]]:
...
def make_namedtuple_validator[
    NamedTupleT: NamedTuple
](namedtuple_cls: type[NamedTupleT], config: type["BaseConfig"]) -> Callable[
    [tuple[Any, ...]], NamedTupleT
]:
