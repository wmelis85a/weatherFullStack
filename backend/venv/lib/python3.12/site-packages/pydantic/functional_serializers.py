...
if TYPE_CHECKING:
    type _Partial = "partial[Any] | partialmethod[Any]"

    type FieldPlainSerializer = "core_schema.SerializerFunction | _Partial"
    """A field serializer method or function in `plain` mode."""

    type FieldWrapSerializer = "core_schema.WrapSerializerFunction | _Partial"
    """A field serializer method or function in `wrap` mode."""

    type FieldSerializer = "FieldPlainSerializer | FieldWrapSerializer"
...
def model_serializer[
    ModelPlainSerializerT: ModelPlainSerializer
](f: _ModelPlainSerializerT, /) -> _ModelPlainSerializerT: ...
...
def model_serializer[
    ModelPlainSerializerT: ModelPlainSerializer,
    ModelWrapSerializerT: ModelWrapSerializer,
](
