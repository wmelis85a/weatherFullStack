...
type ModifyCoreSchemaWrapHandler = GetCoreSchemaHandler
type GetCoreSchemaFunction = Callable[
    [Any, ModifyCoreSchemaWrapHandler], core_schema.CoreSchema
]
type ParametersCallback = "Callable[[int, str, Any], Literal['skip'] | None]"
...
def filter_field_decorator_info_by_field[
    FieldDecoratorInfoType: FieldDecoratorInfo
](validator_functions: Iterable[Decorator[FieldDecoratorInfoType]], field: str) -> list[
    Decorator[FieldDecoratorInfoType]
]:
    return [
        dec
