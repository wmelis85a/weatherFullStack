...
_VALIDATOR_F_MATCH: Mapping[
    ...
    schema,
    _: core_schema.no_info_before_validator_function(f, schema),
    ("after", "no-info"): lambda f,
    schema,
    _: core_schema.no_info_after_validator_function(f, schema),
    ("plain", "no-info"): lambda f,
    _1,
    _2: core_schema.no_info_plain_validator_function(f),
    ("wrap", "no-info"): lambda f,
    schema,
    _: core_schema.no_info_wrap_validator_function(f, schema),
    ("before", "with-info"): lambda f,
    schema,
    field_name: core_schema.with_info_before_validator_function(
        f, schema, field_name=field_name
    ),
    ("after", "with-info"): lambda f,
    schema,
    field_name: core_schema.with_info_after_validator_function(
        f, schema, field_name=field_name
    ),
    ("plain", "with-info"): lambda f,
    _,
    field_name: core_schema.with_info_plain_validator_function(
        f, field_name=field_name
    ),
    ("wrap", "with-info"): lambda f,
    schema,
    field_name: core_schema.with_info_wrap_validator_function(
        f, schema, field_name=field_name
    ),
}
