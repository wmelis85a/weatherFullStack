...
if typing.TYPE_CHECKING:
    type MappingIntStrAny = "typing.Mapping[int, Any] | typing.Mapping[str, Any]"
    type AbstractSetIntStr = "typing.AbstractSet[int] | typing.AbstractSet[str]"
...
if typing.TYPE_CHECKING:
    ...
    def LazyClassAttribute[T](name: str, get_value: Callable[[], T]) -> T: ...
...
def smart_deepcopy[Obj](obj: Obj) -> Obj:
...
class deprecated_instance_property[ModelT: "BaseModel", RT]:
