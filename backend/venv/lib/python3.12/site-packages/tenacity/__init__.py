...
class BaseRetrying(ABC):
    ...
    def copy(
        ...
        retry_error_callback: (
            t.Callable[["RetryCallState"], t.Any] | None | object
        ) = _unset,
    ) -> "Self":
    ...
    def __iter__(self) -> t.Generator[AttemptManager]:
        self.begin()
...
@t.overload
def retry[WrappedFn: t.Callable[..., t.Any]](func: WrappedFn) -> WrappedFn: ...


@t.overload
def retry(
    sleep: t.Callable[[int | float], None | t.Awaitable[None]] = sleep,
    stop: "StopBaseT" = stop_never,
    wait: "WaitBaseT" = wait_none(),
    ...
    before_sleep: (
        t.Callable[["RetryCallState"], None | t.Awaitable[None]] | None
    ) = None,
    reraise: bool = False,
    retry_error_cls: type["RetryError"] = RetryError,
    retry_error_callback: (
        t.Callable[["RetryCallState"], t.Any | t.Awaitable[t.Any]] | None
    ) = None,
